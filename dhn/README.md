...
It is possible to run a **coupled simulation**, where the MPC provides control signals (e.g., inlet temperature setpoints) to the TESPy heat pump model, while TESPy returns the resulting thermal and electrical performance (e.g., heat output, COP, power consumption).  
